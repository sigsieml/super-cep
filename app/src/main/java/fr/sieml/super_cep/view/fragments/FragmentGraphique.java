package fr.sieml.super_cep.view.fragments;
...
import fr.sieml.super_cep.controller.Conso.ConsoProvider;
import fr.sieml.super_cep.controller.Conso.ConsoProviderListener;
import fr.sieml.super_cep.controller.Conso.Energie;
import fr.sieml.super_cep.controller.ReleveViewModel;
import fr.sieml.super_cep.databinding.FragmentGraphiqueBinding;
import fr.sieml.super_cep.controller.Conso.Anner;
import fr.sieml.super_cep.controller.Conso.ConsoParser;
import fr.sieml.super_cep.databinding.ItemEnergieBinding;
    ...
    private void setUpSurface() {
        ...
        binding.editTextNumberSurfaceBatiment.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                try {
                    releveViewModel.setSurfaceTotaleChauffe(s.toString().isEmpty() ? 0 : Float.parseFloat(s.toString().replace(",", ".")));
