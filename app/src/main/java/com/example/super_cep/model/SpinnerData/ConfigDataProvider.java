...
public class ConfigDataProvider {
    ...
    public ConfigDataProvider(){
        ...
        configData.put("typeChauffageProducteurEmetteur", List.of("Radiateurs électriques", "Poêles à bois", "Pompes à chaleur air-air", "Poêles à granulés"));
        ...
        configData.put("marqueProducteurEmetteur", List.of("Mitsubishi","Daikin","Hitachi"));
